...
### Исходные файлы проектов, продемонстрированных на занятии, будут загружены 04.11.22

### Рекомендуемые источники информации по теме
- [Онлайн книга про OpenGL (learnopengl.com)](https://learnopengl.com/Introduction)
- [Перевод книги на русский язык (ravesli.com)](https://learnopengl.com/Introduction)
